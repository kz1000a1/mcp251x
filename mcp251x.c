...
module_param_array(rxbn_op_mode, int, NULL, S_IRUGO|S_IWUSR);
...
module_param_array(rxbn_mask, int, NULL, S_IRUGO|S_IWUSR);
...
module_param_array(rxbn_filters, int, NULL, S_IRUGO|S_IWUSR);
